...
interface AddColumnToModeModalProps {
  isOpen: boolean;
  onClose: () => void;
  modeName: string;
...
export const AddColumnToModeModal: React.FC<AddColumnToModeModalProps> = ({
  isOpen,
  onClose,
  modeName,
  onAddColumn,
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400">
                Thêm cột vào chế độ: <span className="font-semibold text-indigo-600 dark:text-indigo-400">{modeName}</span>
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="VD: Đang đánh giá, Tuần sau, Lưu trữ..."
